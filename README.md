<h1 align="center">
  <br>
  <!-- image/logo link -->
  <a href="https://mitchellmunderwood.github.io/README-Generator-CLI/"><img src="./README-support/logo.png" alt="title" width="200" height="200" ></a>
...
Create beautiful Readme docs in the CLI.
</h4>
...
Readme Generator CLI is currently deployed with Deployment. <a href="">Go to Live</a>.
<br/> -->
...
A simple CLI tool that walks the user through creating a README document for a standard github project.
...
Readme Generator CLI is licensed under the terms of the [MIT License](https://opensource.org/licenses/MIT) and is available for free.
...
Fork the repo, run `npm install` and then `node index.js`.

<br/>

### Usage

Usage of the CLI application is demonstrated in a tutorial video. <a href="https://mitchellmunderwood.github.io/README-Generator-CLI/">Go to Video</a>.
